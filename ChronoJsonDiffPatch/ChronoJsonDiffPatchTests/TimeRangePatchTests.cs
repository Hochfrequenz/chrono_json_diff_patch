...
public class TimeRangePatchTests
{
    ...
    {
        var openPatch = new TimeRangePatch(patch: null, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero));
    ...
    {
        var closedPatch = new TimeRangePatch(patch: null, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero), to: new DateTimeOffset(2023, 1, 1, 0, 0, 0, TimeSpan.Zero));
    ...
    public void Test_ToString()
    {
        ...
        var trp = new TimeRangePatch(patch: patch, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero), to: new DateTimeOffset(2023, 3, 2, 1, 0, 0, 0, TimeSpan.Zero));
    ...
    {
        ITimeRange trp = new TimeRangePatch(patch: null, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero));
    ...
    {
        ITimeRange trp = new TimeRangePatch(patch: null, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero), to: new DateTimeOffset(2023, 3, 2, 1, 0, 0, 0, TimeSpan.Zero));
        var actual = trp.End;
    ...
    public void Test_End_Property_Lower_than_Start()
    {
        ...
        {
            _ = new TimeRangePatch(patch: null, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero), to: new DateTimeOffset(2021, 3, 2, 1, 0, 0, 0, TimeSpan.Zero));
        };
    ...
    {
        ITimeRange trp = new TimeRangePatch(patch: null, from: new DateTimeOffset(2022, 1, 1, 0, 0, 0, TimeSpan.Zero), to: null);
        var actual = trp.End;
